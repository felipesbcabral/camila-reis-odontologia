        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[calc(100vh-12rem)]">
          ...
          >
            ...
            <motion.h1
              ...
              className="font-serif text-4xl sm:text-5xl lg:text-[56px] font-medium text-dark leading-[1.1] mb-6"
            >
            ...
            <motion.p
              variants={itemVariants}
              className="text-dark-500 text-lg leading-relaxed mb-8 max-w-lg"
            >
            ...
            >
              <Button
                ...
                className="bg-rose-400 hover:bg-rose-500 text-white rounded-full px-8 py-3 text-sm font-medium transition-all duration-300 hover:scale-[1.02] hover:shadow-button"
              >
                Agendar Avaliação
              </Button>
              <Button
                ...
                variant="outline"
                className="border-dark-200 text-dark hover:bg-dark hover:text-white rounded-full px-8 py-3 text-sm font-medium transition-all duration-300"
              >
                Ver Casos Reais
              </Button>
            </motion.div>
              ...
              {stats.map((stat, index) => (
                ...
                >
                  <div className="flex items-center justify-center lg:justify-start gap-2 mb-1">
                    ...
                    <span className="font-serif text-2xl lg:text-3xl font-semibold text-dark">
                      {stat.value}
                    </span>
                  </div>
                  <p className="text-dark-500 text-xs">{stat.label}</p>
                  <p className="text-dark-400 text-xs">{stat.sublabel}</p>
                </motion.div>
              ))}
            </motion.div>
          </motion.div>
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -left-4 lg:bottom-8 lg:-left-8 bg-white rounded-2xl shadow-card p-4 flex items-center gap-3 animate-pulse-rose"
              >
                <div className="w-12 h-12 rounded-xl bg-rose-100 flex items-center justify-center">
                  <Calendar className="w-6 h-6 text-rose-500" />
                </div>
                <div>
                  <p className="text-dark-400 text-xs">Próxima disponível</p>
                  <p className="text-dark font-semibold text-sm">Hoje às 14h</p>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-4 lg:top-8 lg:-right-8 bg-white rounded-2xl shadow-rose-glow p-4 border border-rose-100"
              >
                <div className="text-center">
                  <Award className="w-8 h-8 text-rose-400 mx-auto mb-1" />
                  <p className="text-rose-400 font-serif text-lg font-semibold">Emerald</p>
